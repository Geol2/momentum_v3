...
export const NOTICES = [
  {
    ...
    title: '습관 알림 추가',
    body: [
      '• 습관을 깜빡하지 않게 하루 두 번 알려드려요',
      '• 아침 7시 — 오늘 체크할 습관을 미리 알려드려요',
      '• 밤 10시 — 아직 체크하지 않은 습관이 남아 있으면 알려드려요',
      '• 그날 습관을 다 체크했으면 밤 알림은 오지 않아요',
      '• 설정(⚙) → 습관 알림에서 끄거나 시간을 바꿀 수 있어요 (아침 6·7·8시 / 밤 9·10·11시)',
      '• 알림을 받으려면 먼저 설정에서 "시간 알림 받기"를 켜주세요',
    ].join('\n'),
  },
  {
    date: '2026-08-11',
  ...
  },
  {
    ...
    body: [
      '• 비밀번호를 잊으셨다면 이제 직접 재설정할 수 있어요',
      '• 로그인 화면에서 "비밀번호를 잊으셨나요?" → 가입한 이메일로 6자리 코드를 보내드려요',
      '• 코드와 새 비밀번호를 입력하면 바로 바뀝니다',
      '',
      '• 로그인 화면을 새로 단장했어요. 시계와 시간대에 맞는 인사말이 함께 보여요',
      '',
      '• 게임에 보스가 생겼어요. 10스테이지마다 나타나고, 쓰러뜨려야 다음 스테이지로 갑니다',
      '• 스테이지가 오를수록 한 번에 덤비는 적이 더 많아져요 (최대 30마리)',
      '• 획득한 아이템이 왼쪽 위에 슬롯으로 표시돼요. 매직완드 레벨과 발사 속도까지 보여요',
      '• 게임 시야가 넓어졌어요. 더 멀리서 보이고 휠로 더 크게 당길 수 있어요',
      '• 게임 조작 안내가 화면을 가리지 않게 정리됐어요. 오른쪽 위 ? 버튼으로 언제든 볼 수 있어요',
    ].join('\n'),
  },
  {
    date: '2026-07-28',
